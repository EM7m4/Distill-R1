...
class SequentialFunctionRewardManagerMixin:
    ...
    def compute_reward_sequential(self, data: DataProto) -> Tuple[torch.Tensor, dict[str, list[float]]]:
        ...
        for i in range(len(data)):
            ...
            accuracy_tensor[i, cur_response_length - 1] = score["accuracy"]
            for key, value in score.items():
                reward_metrics[key].append(value)

        return reward_tensor, format_tensor, accuracy_tensor, reward_metrics
...
class NewAutoRewardManager(BatchFunctionRewardManagerMixin, SequentialFunctionRewardManagerMixin):
    """New Reward manager for rule-based reward."""
